...
def init_db():
    ...
    users = [
        ...
        ('Lucas Bracamonte', hash_password('lucbra10'), 'Lucas', 'Profesor', None),
        ('Ramongonex', hash_password('ragoex20'), 'Ramón', 'Alumno', None),
        ...
        ('koke', hash_password('koke6'), 'Koke', 'player', 6),
        ('sorloth', hash_password('sorloth9'), 'Alexander Sørloth', 'player', 9),
        ...
        ('lenglet', hash_password('lenglet15'), 'Clément Lenglet', 'player', 15),
